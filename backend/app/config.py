...
class Settings(BaseSettings):
    ...
    TENDER_SUMMARY_USE_LLM_FOR_AIU: bool = True
    TENDER_SUMMARY_AIU_LLM_MAX_CHARS: int = 8_000
    TENDER_SUMMARY_AIU_LLM_MIN_CONFIDENCE: float = 0.70
    TENDER_SUMMARY_PRESUPUESTO_OCR_ENABLED: bool = True
    TENDER_SUMMARY_PRESUPUESTO_OCR_MIN_TEXT_CHARS: int = 80
    TENDER_SUMMARY_PRESUPUESTO_OCR_RENDER_SCALE: float = 1.25
    TENDER_SUMMARY_PRESUPUESTO_VISION_DETAIL: str = "high"
    TENDER_SUMMARY_PRESUPUESTO_VISION_MODEL: str = ""
    ...
    TENDER_REQUIREMENTS_SCORING_LLM_FALLBACK: bool = True
    TENDER_REQUIREMENTS_SCORING_LLM_FALLBACK_MAX_CHARS: int = 6_000
