...
from app.services.tender_requirements.residual_capacity_extraction import (  # noqa: E402
    extract_capacidad_residual,
)
...
EXTRACTORS = {
    ...
    "capacidad_residual": extract_capacidad_residual,
